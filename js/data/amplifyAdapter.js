...
const SELECTION = {
  ...
  Document: 'id corpId scope fiscalYear category title description fileName s3Key contentType size uploadedBy attestationConfirmed attestationBy attestationAt createdAt',
  Signature: 'id corpId docKey signerName method dataUrl signedDate createdAt',
